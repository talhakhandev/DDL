            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="fname" id="title" placeholder="  {{ __('frontstaticword.EnterFirstName') }}" value="{{ old('fname') }}" required>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="lname">{{ __('frontstaticword.LastName') }}:<sup class="redstar">*</sup></label>
                  <input type="text" class="form-control" name="lname" id="title" placeholder="  {{ __('frontstaticword.EnterLastName') }}" value="{{ old('lname') }}"  required>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="email" value="" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" id="title" placeholder="Enter {{ __('frontstaticword.Email') }}" value="{{ old('email') }}" required>
                </div>
              </div>
          ...
          <form method="POST" action="{{ route('guest.login') }}">
              ...
              <div class="form-group">
                <label for="fname">{{ __('frontstaticword.Email') }}:<sup class="redstar">*</sup></label>
                  <input id="email" type="email" class="form-control" placeholder="Enter Your E-Mail"   name="email"  required autofocus>
