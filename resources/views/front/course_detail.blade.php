                                                            ...
                                                            @if($rel->courses->discount_price == !NULL)
                                                                <div class="rate text-right">
                                                                    <ul>
                                                                        ...
                                                                        <li><a><b><strike>{{ activeCurrency()->symbol }}{{ price_format(  currency($rel->courses->discount_price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = false)) }}</strike></b></a></li>
