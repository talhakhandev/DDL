        ...
        <div class="card-body">
          ...
          <div class="form-group col-md-6">
            <label for="exampleInputTit1e">{{ __('Designation') }}:<sup class="text-danger">*</sup></label>
                <input type="text" class="form-control" value="{{ $test->designation }}" name="designation" id="exampleInputTitle" placeholder="{{ __('adminstaticword.Enter') }} {{ __('Designation') }}" value="">
          </div>
