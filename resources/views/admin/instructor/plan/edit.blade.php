                    ...
                    <form action="{{ url('subscription/plan', $plans->id) }}" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <label for="exampleInputDetails">{{ __('adminstaticword.Paid') }}:</label><br>  
                                  ...
                                  <div style="{{ $plans->type == 1 ? '' : 'display:none' }}" id="doabox">
                                    ...
                                    <input step="0.01" type="text" inputmode="numeric" pattern="[-+]?[0-9]*[.,]?[0-9]+"  class="form-control" name="price" id="exampleInputPassword1" placeholder="{{ __('adminstaticword.Enter') }} {{ __('adminstaticword.Price') }}" value="{{ $plans->price }}">
                                 
                                  <br>
                                    <label for="exampleInputSlug">{{ __('adminstaticword.DiscountPrice') }}: <sup class="redstar">*</sup></label>
                                    <input step="0.01" type="text" inputmode="numeric" pattern="[-+]?[0-9]*[.,]?[0-9]+" class="form-control" name="discount_price" id="exampleInputPassword1" placeholder="{{ __('adminstaticword.Enter') }} {{ __('adminstaticword.DiscountPrice') }}" value="{{ $plans->discount_price }}">
                                  </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input min="1" class="form-control" name="duration" type="number" id="duration" value="{{ $plans->duration }}" placeholder="{{ __('adminstaticword.Enter') }} {{ __('adminstaticword.Duration') }}">
