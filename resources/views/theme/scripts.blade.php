...
<script>
  ...
  $('#list').click(function(event){
    ...
    $('#posts .course-bought-block-one').removeClass('col-lg-12');
    ...
    $('#posts .categories-popularity-dtl-block').removeClass('col-lg-12');
  ...
  $('#grid').click(function(event){
    ...
    $('#posts .course-bought-block-one').addClass('col-lg-12');
    ...
    $('#posts .categories-popularity-dtl-block').addClass('col-lg-12');
